-- ==========================================================
-- RxLens : Extended Seed Database
-- Purpose: Exhaustive testing of matching logic
-- DB: MySQL
-- ==========================================================
...
CREATE TABLE brand_medicine_composition (
    ...
    amount_mg DECIMAL(8,2) NOT NULL,

    CONSTRAINT fk_brand_medicine
        FOREIGN KEY (medicine_id)
        REFERENCES brand_medicines(id)
        ON DELETE CASCADE,
...
CREATE TABLE jan_aushadhi_composition (
    ...
    CONSTRAINT fk_jan_medicine
        FOREIGN KEY (medicine_id)
        REFERENCES jan_aushadhi_medicines(id)
        ON DELETE CASCADE,
